...
//=======
					"                                             | simplismente acabou.         								     |							 |       \n" +
//>>>>>>> branch 'master' of https://github.com/GOM001/PI
					"                                             |______________________________________________________________________________________________|       \n" +
					"                                            /                                                                                                       \n" +
					"                                           /                                                                                                        \n" +
					"                  ██████████████████████                                                                                                            \n" + 
			...
			System.out.println("\n                             _________________________________________________________________________                     \n     "
					+ "                       |   alguém para te ajudar e outro para atrapalhar, preste muita          |                   \n "
					+ "                           |            atenção e obtenha a ressurreição.                           |      \n"
			...
			System.out.println("\n"
					...
					+ "                                    Imediatamente Protagonista e transportado para uma floresta escura, onde mal conseguia\n"
					+ "                             ver um palmo à sua frente ele percebe movimento nos arbustos ou seja lá o que estivesse ao seu redor.\n"
					+ "                                        De repente ele vê um figura tomar forma diante de seus olhos, um espantalho\n"
					+ "                                      de paletó com um sorriso estampado no que parecia ser chamado de rosto.\n"
					+ "");
			centro(16);
			continuar();
