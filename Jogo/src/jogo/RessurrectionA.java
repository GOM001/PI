		...
		static void desafio1() {
			...
			do {
				...
				if (lul.equals(resp)) {
					...
					System.out.println("Você de mim não ira passa desista!!!");
					n1++;
					gm = true;
					drible();
					continuar();
